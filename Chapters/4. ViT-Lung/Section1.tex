...
\begin{enumerate}
    ...
    \item \textbf{Full-tuning}\\
          ...
          \textbf{Modelo ViT}: Con la misma premisa anterior el modelo \textit{ViT} es descongelado completamente
...
La Tabla~\ref{table:res-model-covid} muestra un resumen del rendimiento de los modelos propuestos.
Las imágenes
...
muestra incluyendo \textit{COVID-19}. Nótese que el modelo propuesto tiene su mejor
...
y \textit{COVID-19} se muestran en el último renglón de la tabla \ref{table:res-model-covid}.

\begin{table*}[tb]
    \centering
    \begin{tabular}{|l||c|c|c|c|}
        \hline
    {\bf Phatology} 	    	&	\multicolumn{4}{c|}{\bf Modelo propuesto ResNet50}  \\
    \cline{2-5}
...
\begin{table*}[tb]
    ...
    \begin{tabular}{|l||c|c|c|c|}
        \hline
    {\bf Phatology} 	    	&	\multicolumn{4}{c|}{\bf Modelo propuesto ViT}  \\
    \cline{2-5}
                        &	AUC-PR	&	AUC-ROC 	& F1-Score  & Acc.  \\
        \hline \hline
...
\begin{table*}[tb]
    ...
    \begin{tabular}{|l||c|c|c|c|c|c|c|l|}
        \hline
        \multicolumn{1}{|c||}{}	&	\multicolumn{5}{c|}{\bf Modelos comparativos}    &\multicolumn{2}{c|}{\bf Propuestas} & 	\\
        \cline{2-9}
