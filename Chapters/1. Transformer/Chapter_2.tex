...
\cite{GRU1} como una alternativa más rápida computacionalmente y con similar rendimiento que las
\textit{LSTM} \cite{GRU2}. A diferencia de las \textit{LSTM}, las \textit{GRU} prescinden de la
\textit{Celda de Memoria} y utilizan un par de compuertas (la \textit{Compuerta de Entrada} y la de
\textit{Olvido}) para decidir que información conservar o no y codificarla dentro del estado oculto.
