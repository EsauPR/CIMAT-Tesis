...
solo una vez en memoria el este valor en cada iteración y recalculándolo cuando se necesite de nuevo
al utilizar \textit{Back-Propagation} a través de capas reversibles. Si bien, es más costoso computacionalmente permite usar mucho
...
similaridad entre consultas y llaves, algo que sería más dificil si sus matrices de proyección fuesen
muy distintas.
...
Fourier o lo largo de la dimensión de los  embeddings y de las secuencias, probando que usando
\textit{FFT} (Fast Fourier Transform) es suficiente para abstraer y modelar las relaciones. O
\citeauthor*{DBLP:journals/corr/abs-2108-09084} quienes cambian la atención entre todas las consultas
y llaves por una sola con todas las llaves. Para esto, a través de atención sumarizan todos las
consultas en una consulta global. Este proceso es repetido con las llaves y valores como observa en
la figura \ref{fig:fast-former}
